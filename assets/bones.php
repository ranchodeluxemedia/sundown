...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-overlay', 'https://cdn.jsdelivr.net/jquery.loadingoverlay/latest/loadingoverlay.min.js', array( 'jquery' ), '', true );
    wp_register_script( 'bones-overlay-progress', 'https://cdn.jsdelivr.net/jquery.loadingoverlay/latest/loadingoverlay_progress.min.js', array( 'jquery' ), '', true );
    ...
    wp_enqueue_script( 'bones-overlay' );
    wp_enqueue_script( 'bones-overlay-progress' );
